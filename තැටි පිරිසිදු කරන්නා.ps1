...
$SelectDiskLabelText = "තැටිය තෝරන්න:"
$FreeSpaceLabelText = "නිදහස් අවකාශය (ගිගාබයිට්): "
$TotalSpaceLabelText = "මුළු අවකාශය (ගිගාබයිට්): "
$JunkFoundLabelText = "කසළ සොයා ගන්නා ලදී (ගිගාබයිට්):"
$CleanDiskBtnText = "තැටිය පිරිසිදු කරන්න *ගොනු මකන්න*"
$SpaceCleanedLabelText = "පිරිසිදු කළ අවකාශය (ගිගාබයිට්): "
$LogFileLabelText = "ලොග් ගොනුව හමු විය: $abcdefg"
$CreditLabelText = "ජිම් ටයිලර්ගේ පිටපත - PowerShellEngineer.com"
$LogFileLocatedText = "ලොග් ගොනුව හමු විය"
$AnalyzingDriveText = "ධාවක විශ්ලේෂණය කරමින්..."
$BrowsersAreRunningText = "බ්‍රවුසර් ක්‍රියාත්මක වේ... පරිශීලකයාට දැනුම් දෙන්න..."
$PleaseCloseBrowsersText = "කරුණාකර සියලුම වෙබ් බ්‍රව්සර් වසා නැවත උත්සාහ කරන්න."
$CleaningDriveText = "ඩ්‍රයිව් පිරිසිදු කිරීම..."
